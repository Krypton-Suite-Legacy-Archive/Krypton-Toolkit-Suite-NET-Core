...
namespace KryptonToolkitUpdater.UI
{
    public partial class UpdaterMainForm : KryptonForm
    {
        ...
        {
            CheckForUpdates("https://github.com/Wagnerp/Krypton-NET-5.4900/blob/master/Updates/update.xml");
        }
        ...
        {
            KryptonMessageBox.Show("This utility will enable you to check for and download updates for Krypton .NET 5.490.", "Help", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
